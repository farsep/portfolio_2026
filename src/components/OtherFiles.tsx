...
const fileGroups = [
    {
        ...
        items: [
            { name: "Mercado Libre - Globant Certified Tech Developer", path: "/portfolio_files/Digital House/Mercado Libre - Globant Certified Professional Developer Arnie Farid Espinoza Pachas.pdf", type: "pdf" },
